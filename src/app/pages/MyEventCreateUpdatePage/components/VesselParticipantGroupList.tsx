        ...
        },
        {
            ...
            render: (text, record) => {
                return <Space size="middle">
                    ...
                    <BorderedButton data-tip={t(translations.tip.delete_class)} danger onClick={() => showDeleteGroupModal(record)}>{t(translations.vessel_participant_group_list_page.delete)}</BorderedButton>
                    <ReactTooltip/>
                </Space>;
            }
        },
