export const steps = [
    ...
    },
    {
        ...
        content: 'Begin by typing any race name in the search bar.'
    },
    {
        selector: '.search-step-results',
        content: 'On the map view you will see all the results about your keyword.'
    },
    {
        selector: '.search-step-listview-results',
        content: 'Or event better, you can check the results in the list view by clicking on the listview tab.'
    },
    {
        selector: '.search-step-listview-show-detail-results',
        content: 'From here you will see your searches with detailed information.'
    },
    {
        selector: '.playback-step',
        content: 'You can click on one of the results to replay or view a race.'
    },
    {
        selector: '.event-step',
    ...
    },
    {
        ...
        content: 'You may need to add a event website for people to get more details',
    },
]