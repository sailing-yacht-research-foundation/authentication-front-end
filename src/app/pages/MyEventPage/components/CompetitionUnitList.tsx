...
import { DeleteCompetitionUnitModal } from '../../CompetitionUnitListPage/components/DeleteCompetitionUnitModal';
import NoResult from '../../CompetitionUnitListPage/assets/no-results.json'
