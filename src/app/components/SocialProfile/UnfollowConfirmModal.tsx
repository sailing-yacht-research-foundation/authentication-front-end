...
export const UnfollowConfirmModal = (props: IUnfollowConfirmModal) => {
    ...
    const { profileName, unfollow, hideModal, visible, isLoading } = props;

    const { t } = useTranslation();

    return (
        <Modal confirmLoading={isLoading} visible={visible} onOk={unfollow} onCancel={hideModal} title={t(translations.public_profile.unfollow_people, { profileName: profileName })}>
